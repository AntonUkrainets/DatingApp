...
var ListsResolver = /** @class */ (function () {
    ...
    ListsResolver.prototype.resolve = function (route) {
        var _this = this;
        return this.userService.getUsers(this.pageNumber, this.pageSize, null, this.likesParam).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (model) {
        var _this = this;
        return this.http.post(this.baseUrl + 'login', model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
            var user = response;
            if (user) {
...
var MemberDetailComponent = /** @class */ (function () {
    ...
    MemberDetailComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"],
            src_app_services_alertify_service__WEBPACK_IMPORTED_MODULE_2__["AlertifyService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]])
...
var MemberMessagesComponent = /** @class */ (function () {
    ...
    MemberMessagesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"],
            src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], src_app_services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"]])
...
var PhotoEditorComponent = /** @class */ (function () {
    ...
    PhotoEditorComponent.prototype.deletePhoto = function (id) {
        var _this = this;
        this.alertify.confirm('Are you sure, you wanna delete this photo', function () {
...
var MessagesComponent = /** @class */ (function () {
    function MessagesComponent(userSevice, authService, route, alertify) {
    ...
    MessagesComponent.prototype.loadMessages = function () {
        var _this = this;
        this.userSevice.getMessages(this.authService.decodedToken.nameid, this.pagination.currentPage, this.pagination.itemsPerPage, this.messageContainer)
            .subscribe(function (res) {
    ...
    MessagesComponent.prototype.deleteMessages = function (id) {
        var _this = this;
        this.alertify.confirm('Are you sure you wanna delete this message', function () {
            _this.userSevice.deleteMessage(id, _this.authService.decodedToken.nameid)
                .subscribe(function () {
...
var NavComponent = /** @class */ (function () {
    function NavComponent(authService, alertify, routes) {
        this.authService = authService;
        this.alertify = alertify;
        this.routes = routes;
        this.model = {};
...
module.exports = __webpack_require__(/*! C:\Users\Anton\Desktop\Programming\Angular\DatingApp-SPA\src\main.ts */"./src/main.ts");
